  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div>
        ...
        <input type="number" value={energyLevel} onChange={(e) => setEnergyLevel(Number(e.target.value))} />
      </div>
      ...
      <div>
        ...
        <input type="text" value={injuries} onChange={(e) => setInjuries(e.target.value)} />
      </div>
